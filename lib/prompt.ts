...
- Answers should be factual, concise, and match the question.
  ...
  "categories": [
    {
      "title": string,
      "questions": [
        {"points": 100, "question": string, "answer": string},
        {"points": 200, "question": string, "answer": string},
        {"points": 300, "question": string, "answer": string},
        {"points": 400, "question": string, "answer": string},
        {"points": 500, "question": string, "answer": string},
        {"points": 600, "question": string, "answer": string}
      ]
    },
    ...
  ]
